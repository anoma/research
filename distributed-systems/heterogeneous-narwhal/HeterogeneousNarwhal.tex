...
%draft,%
dvipsnames%
%,dvi% ← for externalizing dvis instead of pdfs / also needs dvilualatex
]{article}
...
\usepackage[%
%hypertex% ← add this option for dvisvgm
]{hyperref} 
...
% \tikzset{external/system call={dvilualatex \tikzexternalcheckshellescape -halt-on-error -interaction=batchmode  -jobname "\image" "\texsource"}}
