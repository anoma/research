...
\section{Context}
\label{sec:context}
\todo[inline,caption={},color=yellow]{%
  this section needs to be written after we've narrowed down the audience %
  }%
\color{gray}
...
we also use assumptions about safety, %
that allow us to describe how and under which conditions %
...
\begin{figure}[htb]
  \centering%\footnotesize
    \tikzsetnextfilename{scale_out_narwhal_architecture}
